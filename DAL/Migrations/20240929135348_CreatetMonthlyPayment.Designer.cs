...
namespace DAL.Migrations
{
    ...
    [Migration("20240929135348_CreatetMonthlyPayment")]
    partial class CreatetMonthlyPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.TrnMonthlyPayment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DAL.Models.TrnFunding", b =>
                {
                    b.HasOne("DAL.Models.MstLoans", null)
                        .WithMany("trnFunding")
                        .HasForeignKey("MstLoansId");

                    b.HasOne("DAL.Models.MstUser", null)
                        .WithMany("trnFunding")
