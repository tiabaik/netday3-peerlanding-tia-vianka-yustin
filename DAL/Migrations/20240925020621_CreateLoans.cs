    ...
    public partial class CreateLoans : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    borrowe_id = table.Column<string>(type: "text", nullable: false),
                    amount = table.Column<decimal>(type: "numeric", nullable: false),
                    interesr_rate = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mst_loans_mst_user_borrowe_id",
                        column: x => x.borrowe_id,
